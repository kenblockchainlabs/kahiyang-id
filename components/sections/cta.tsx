...
export default function CTA() {
  return (
    <section className="relative min-h-[70vh] w-full bg-[#0a0a0a] py-32 px-6 flex items-center justify-center">
...
<div className="w-8 h-px bg-cyan-400/50"/><span className="text-[11px] text-white/30 tracking-[0.3em] uppercase font-light">Mulai Sekarang</span><div className="w-8 h-px bg-cyan-400/50"/>
        ...
        <motion.h2 initial={{opacity:0,y:50}} whileInView={{opacity:1,y:0}} transition={{duration:1,delay:0.2,ease:[0.16,1,0.3,1]}} viewport={{once:true,margin:"-100px"}} className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light text-white/90 tracking-tight leading-tight mb-8">
