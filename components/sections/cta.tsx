...
export default function CTA() {
  return (
    <section className="relative min-h-[70vh] w-full bg-white py-32 px-6 flex items-center justify-center">
      ...
      <div className="relative z-20 text-center max-w-3xl mx-auto">
        ...
        <motion.h2 initial={{opacity:0,y:50}} whileInView={{opacity:1,y:0}} transition={{duration:1,delay:0.2,ease:[0.16,1,0.3,1]}} viewport={{once:true,margin:"-100px"}} className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light text-black/90 tracking-tight leading-tight mb-8">
          Siap Upgrade<br/><span className="bg-gradient-to-r from-cyan-600 to-cyan-400 bg-clip-text text-transparent">Akun TikTok Lo?</span>
        </motion.h2>
