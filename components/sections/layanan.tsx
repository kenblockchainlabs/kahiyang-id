...
<span className="text-[11px] text-black/20 tracking-[0.3em] uppercase font-light">{s.num}</span>
                  ...
                  {s.href ? (
                    <a href={s.href} target="_blank" rel="noopener noreferrer" className="mt-6 inline-flex items-center gap-2 text-[12px] text-cyan-700 hover:text-cyan-500 transition-colors">
                      <span className="tracking-[0.15em] uppercase">Selengkapnya</span><span>→</span>
                    </a>
                  ) : (
