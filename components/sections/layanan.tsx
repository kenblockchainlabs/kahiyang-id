...
const services = [
  ...
  { num: "02", title: "Kahiyang Studio", desc: "Upload foto produk, dapatkan visual profesional siap jual. Foto produk, poster promo, banner iklan — semua dari 1 foto.", tag: "Visual", href: "https://kahiyang-visual.vercel.app", preview: "/preview/visual.jpg" },
  { num: "03", title: "Viral Analyzer", desc: "Bedah akun lo kayak forensik — kenapa stuck, hook mana yang lemah, kapan waktu posting terbaik. Bukan tebak-tebakan, tapi data dari 500+ akun yang udah dipecahkan.", tag: "AI", href: "https://kahiyang-visual.vercel.app/analyzer", preview: "/preview/analyzer-mobile.jpg" },
  { num: "04", title: "Kelas Affiliate", desc: "Dari nol sampai pecah telur. Mentoring langsung, bedah akun detail, komunitas supportive. Klik untuk lihat paket & harga.", tag: "Education", href: "https://edu.kahiyang.id", preview: "/preview/kelas-mobile.jpg" },
]
