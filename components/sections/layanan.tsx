...
const services = [
  ...
  { num: "03", title: "Viral Analyzer", desc: "Bedah akun lo kayak forensik — kenapa stuck, hook mana yang lemah, kapan waktu posting terbaik. Bukan tebak-tebakan, tapi data dari 500+ akun yang udah dipecahkan.", tag: "AI", href: "https://kahiyang-visual.vercel.app/analyzer", preview: "/preview/analyzer-v2.png" },
  { num: "04", title: "Kelas Affiliate", desc: "Dari nol sampai pecah telur. Mentoring langsung, bedah akun detail, komunitas supportive. Klik untuk lihat paket & harga.", tag: "Education", href: "https://edu.kahiyang.id", preview: "/preview/kelas-v3.png" },
]
