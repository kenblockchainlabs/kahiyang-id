...
const services = [
  ...
  { num: "03", title: "Viral Analyzer", desc: "Bedah akun lo kayak forensik — kenapa stuck, hook mana yang lemah, kapan waktu posting terbaik. Bukan tebak-tebakan, tapi data dari 500+ akun yang udah dipecahkan.", tag: "AI", href: "https://kahiyang-visual.vercel.app/analyzer", preview: "/preview/analyzer-new.png" },
  { num: "04", title: "Kelas Affiliate", desc: "Dari nol sampai pecah telur. Basic Rp 199K (Zoom + Ebook) atau Pro Rp 1Jt (Private Grup + Live Session).", tag: "Education", href: "https://edu.kahiyang.id", preview: "/preview/kelas.jpg" },
]
